...
import { FilterOptions, Model, ComparisonItem } from '../types';
...
export const Market: React.FC = () => {
  ...
  const handleAddToComparison = (model: Model) => {
  ...
  return (
    <div className="flex-1">
      ...
      <div className="flex">
        ...
        {showAdvanced && (
          <div className="w-80 bg-white border-r border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">상세 필터</h3>
      ...
      <ComparisonBar
        ...
        onCompare={() => console.log('Compare models:', comparison.filter(item => item.selected))}
      />
    </div>
  );
};